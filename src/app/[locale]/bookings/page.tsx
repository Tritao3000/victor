  ...
  return (
    <main className="min-h-screen bg-mist">
      ...
      <div className="container mx-auto px-6 py-8">
        <h1 className="mb-8 text-3xl font-bold text-charcoal">{t('title')}</h1>
        ...
        {activeBookings.length > 0 && (
          <div className="mb-8">
            <h2 className="mb-4 text-xl font-semibold text-charcoal">{t('activeBookings')}</h2>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mb-2 flex items-center text-sm text-slate">
                        ...
                        <span>
                          {new Date(booking.scheduledFor).toLocaleDateString(locale, {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric',
                          })}{' '}
                          {t('at')}{' '}
                          {new Date(booking.scheduledFor).toLocaleTimeString(locale, {
                            hour: 'numeric',
                            minute: '2-digit',
                          })}
                        </span>
        ...
        {pastBookings.length > 0 && (
          <div>
            <h2 className="mb-4 text-xl font-semibold text-charcoal">{t('pastBookings')}</h2>
            <div className="space-y-4">
